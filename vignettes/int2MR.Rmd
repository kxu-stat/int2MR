...
-   **model_type**: "3sample"
-   **Prior distributions**: Inverse gamma priors with a shape and scale of 0.01
-   **MCMC Settings**: 4 chains, 10000 iterations with a warm-up period of 2500 iterations, and an adapt_delta of 0.95.

```{r}
result_3sample <- int2MR(data_list_3sample = example_3sample_data,
                 model_type = "3sample",
                 prior_inv_gamma_shape = 0.01,
                 prior_inv_gamma_scale = 0.01,
